...
metadata:
  version: "1.2.0"
description: Deprecated compatibility copy of the primary repo-bootstrap skill. Prefer `.agents/skills/repo-bootstrap`, which defines the current minimal bootstrap behavior.
---

# Repo Bootstrap

Deprecated compatibility layer: prefer `~/.agents/skills/repo-bootstrap`.
This copy intentionally mirrors the current minimal bootstrap policy so users do not see two conflicting versions.
